...
redis_client = redis.Redis(host="localhost", port=6379, db=0) # default is 6379

VECTOR_DIM = 768
INDEX_NAME = "embedding_index"
DOC_PREFIX = "doc:" # anything that starts with doc are KV pairs for this specific case
...
def get_embedding(text: str, model: str = "nomic-embed-text") -> list:
    # returns the embedding version of one string
...
if __name__ == "__main__":
    ...
    # Redis Stack runs on local host 8005
    ...
    q = (
        ...
        # using KNN returns 3 closest matches
    ...
    res = redis_client.ft(INDEX_NAME).search(
        # query_params converts embedding
